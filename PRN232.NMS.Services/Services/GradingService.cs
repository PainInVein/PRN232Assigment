...
public class GradingService
{
    ...
    public async Task<GradingResultHere> GradeAsync(GradingRequest req, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            result.Status = result.Score >= 60 ? "Passed" : "Failed";
        }
        catch (Exception ex)
        {
    ...
    private List<ApiTestCase> GetTestSuite() => new()
    {
        ...
        new()
        {
            ...
            ExpectedStatus = 401,
            AlternateStatus = 404,   // some students return 404 instead of 401 for bad credentials
            Points = 8
        },
        new()
        {
        ...
        // ── 2. LeopardProfile API Endpoints (4.5 points) ──────────────────
        ...
        new()
        {
            ...
            BearerTokenEmail = "administrator@leopard.com",
            BearerTokenPassword = "@1",
            JsonBody = """{"LeopardName":"GraderLeoAdmin","LeopardTypeId":1,"Weight":50,"Characteristics":"Test cat","CareNeeds":"Monitored"}""",
            ExpectedStatus = 201,
            AlternateStatus = 200,
            Points = 8
        },
        new()
        {
            ...
            BearerTokenEmail = "moderator@leopard.com",
            BearerTokenPassword = "@1",
            JsonBody = """{"LeopardName":"GraderLeoMod","LeopardTypeId":1,"Weight":60,"Characteristics":"Test","CareNeeds":"Protected"}""",
            ExpectedStatus = 201,
            AlternateStatus = 200,
            Points = 7
        },
        new()
        {
            ...
            BearerTokenEmail = "member@leopard.com",
            BearerTokenPassword = "@1",
            JsonBody = """{"LeopardName":"Denied","LeopardTypeId":1,"Weight":50,"Characteristics":"x","CareNeeds":"x"}""",
            ExpectedStatus = 403,
            Points = 8
        },
        new()
        {
            ...
            BearerTokenEmail = "developer@leopard.com",
            BearerTokenPassword = "@1",
            JsonBody = """{"LeopardName":"DevDenied","LeopardTypeId":1,"Weight":50,"Characteristics":"x","CareNeeds":"x"}""",
            ExpectedStatus = 403,
            Points = 7
        },
        ...
        new()
        {
            ...
            ExpectedStatus = 200,
            AlternateStatus = 201,   // some students return 201 from PUT; 204 checked separately
            Points = 8
        },
        new()
        {
            ...
            JsonBody = """{"LeopardName":"UpdatedLeo","LeopardTypeId":1,"Weight":55,"Characteristics":"Updated","CareNeeds":"Updated care","ModifiedDate":"2025-06-20T00:00:00"}""",
            ExpectedStatus = 204,
            Points = 0   // 0 pts — only checks that 204 is also acceptable (no double-scoring)
        },
        new()
        {
        ...
        new()
        {
            ...
            ExpectedStatus = 200,
            AlternateStatus = 204,
            PathHint = "delete_4",   // handles students who use ?id=4 query param instead of /{id}
            Points = 5
        },
        new()
        {
        ...
        // ── 3. Error Code Format HB400001 (1.0 point) ─────────────────────
        new()
        {
        ...
        // ── 4. OData / Search filter ───────────────────────────────────────
        new()
        {
            Name = "GET OData $filter=Weight gt 30 – member → 200",
            Method = HttpMethod.Get,
            Path = "/api/LeopardProfile?$filter=Weight gt 30",
            BearerTokenEmail = "member@leopard.com",
            BearerTokenPassword = "@1",
            ExpectedStatus = 200,
            PathHint = "odata",   // handles students who put [EnableQuery] on /search sub-route
            Points = 10
        },
    };
